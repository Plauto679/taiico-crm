...
class AgentStatement(Base):
    ...
    __table_args__ = (UniqueConstraint('period_id', 'prospector_id', name='uq_agent_statement_period_prospector'),)
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    period_id = Column(String(36), ForeignKey('prospector_commission_periods.id'), nullable=False, index=True)
    prospector_id = Column(String(36), ForeignKey('prospectors.id'), nullable=False, index=True)
    month = Column(Date, nullable=False, index=True)
    currency = Column(String(10), nullable=False, default='MXN')
    ...
    carry = Column(JSON, nullable=False, default=list)
    own_amount = Column(Numeric(16, 2), nullable=False, default=0)
    total_amount = Column(Numeric(16, 2), nullable=False, default=0)
    notes = Column(Text, nullable=False, default='')
    revision = Column(Integer, nullable=False, default=1)
    history = Column(JSON, nullable=False, default=list)
    delivery_state = Column(String(30), nullable=False, default='')
